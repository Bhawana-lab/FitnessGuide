        ...
        <div className="relative min-h-screen flex items-center justify-center p-4">
            ...
            {!user ? (
                <div className="relative w-full max-w-md">
                    <div className="bg-black/70 backdrop-blur-sm rounded-2xl shadow-2xl border border-purple-800/30 overflow-hidden">
                        <div className="relative h-48 overflow-hidden">
                            <img 
                                src="https://tse1.mm.bing.net/th/id/OIP.4RVBTCxFocrL-OrhIQ35ZwHaE8?rs=1&pid=ImgDetMain&o=7&rm=3" 
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <h2 className="text-3xl font-bold text-white text-center">
                                    {isLogin ? 'Welcome Back!' : 'JOIN FITGUIDE TODAY'}
                                </h2>
                            </div>
                        </div>
                        {/* form */}
                        <div className="p-8">
                            ...
                            <form onSubmit={(e) => {
                                ...
                                <button 
                                    ...
                                    className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 disabled:from-gray-600 disabled:to-gray-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-[1.02] disabled:transform-none disabled:cursor-not-allowed">
                                    {loading ? (
                ...
                <div className="text-center">
                    <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 backdrop-blur-sm rounded-2xl p-12 border border-purple-800/30 max-w-md mx-auto">
