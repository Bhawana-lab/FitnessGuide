  ...
  const handleChange = (e) => {
    ...
    <div className="bg-gray-800 text-white relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* <div className="max-w-4xl mx-auto px-4"> */}
         ...
         <img src='https://wallpapers.com/images/file/gym-pictures-sgt7k4d788zbg9ca.jpg'
          className='w-full h-full object-cover'
          style={{filter: 'brightness(0.5) saturate(1.1)'}}/>
          <div className="absolute inset-0  bg-transparent bg-gradient-to-r from-purple-400 to-pink-300 opacity-20"></div>
         </div>

        <div className="relative z-10 w-full max-w-4xl mx-auto px-4 mt-6 flex flex-col items-center">
          <div className="text-center mb-8">
          <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent mb-1 mt-10  drop-shadow-lg">
            Get In Touch
          </h2>
          <p className="text-white text-lg drop-shadow">
            Have questions about our fitness programs ?  We would love to hear from you!
          </p>
        </div>
        ...
        <div className="w-[85%] bg-gray-900 bg-opacity-20 rounded-2xl shadow-2xl p-6 md:p-12 backdrop-blur-sm border border-purple-500/20">
          {isSubmitted ? (
            <div className="text-center py-12">
                <img src={Confirm} alt='' className='h-18 w-18 inline-flex rounded-full mb-6'/>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              > Send Message
              </button>
            </form>
            </div>
